...
export const CalculatorRedSvg: React.FC<PropsCalculatorSvg> = ({
  width,
  height,
  customClass,
}) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M12.2007 13.125V15V30H13.9437H26.1444H27.8873V15V13.125H12.2007ZM13.9437 15H26.1444V28.125H13.9437V15ZM15.6866 16.875V20.625H24.4014V16.875H15.6866ZM19.1725 22.5V24.375H20.9155V22.5H19.1725ZM22.6585 22.5V24.375H24.4014V22.5H22.6585Z"
        fill="#F60707"
      />
    </svg>
  );
